...
namespace LittleWeeb
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeChromium()
        {
            ...
            {
                MessageBox.Show("Could not locate interface! Contact the developer here: https://github.com/EldinZenderink/LittleWeeb/issues"); 
            }
        ...
        private void InitializeSharedData()
        {
            ...
            shared.downloadList = new List<dlData>();
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                Debug.WriteLine("DEBUG: Could not close irc :( ");
            ...
            {
                Debug.WriteLine("DEBUG: Could not close websocketserver :( ");
                Debug.WriteLine(ex.ToString());
            }
